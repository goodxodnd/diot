<template>
    <div class="row" :class="$mq" style="position:relative; top:-5%;">
      ...
      <div style="position: relative; top:-6%; left:87%;">
        ...
        <div class="col-md-2">
            <b-card class="bn01" >
                <svg class="icon01" width="40%" height="40%" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
                  <circle cx="3.5" cy="5.5" r=".5"/>
                  <circle cx="3.5" cy="8" r=".5"/>f
                  <circle cx="3.5" cy="10.5" r=".5"/>
                </svg>
                <br>
                <br>
                <b-card-text class="text01">
                Request Authority
                </b-card-text>
        ...
        <div class="col-md-2">
             <b-card class="bn04" >
                <svg class="icon04" width="40%" height="40%" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <br>
                <br>
               <b-card-text class="text04">
                Add to Device
              </b-card-text>
               <b-button class= "request02" style="color:white; background-color:#f04b4c;">Request</b-button>
            </b-card>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-7">
          <div class="Ownership-box">
             <b-card class="dash-card02" title="Ownership Request result"><b-button class= "more brn-primary-outline "  variant="dark" @click="showMsgBoxOne()" style="color:black; background-color:transparent; outline:none;">+More</b-button>
               <b-card-text>
                   <img src="../assets/user.png" style="position:relative; top:-20px; ">
        ...
        <div class="col-md-2">
            <b-card class="bn02" >
                <svg class="icon02" width="40%" height="40%" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-md-2">
          <b-card class="bn05" >
                <svg class="icon05" width="40%" height="40%" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M5 3a5 5 0 0 0 0 10h6a5 5 0 0 0 0-10H5zm6 9a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/>
                </svg>
                <br>
                <br>
              <b-card-text class="text05">
                Add to Service
              </b-card-text>
              <b-button class= "request02" style="color:white; background-color:#f04b4c;">Request</b-button>
            </b-card>
        ...
        <div class="col-md-7">
          <div class="Tier-box">
             <b-card class="dash-card03" title="Tier Request result"><b-button class= "more brn-primary-outline " style="color:black; background-color:transparent; outline:none;">+More</b-button>
               <b-card-text>
                   <img src="../assets/user.png" style="position:relative; top:-20px; ">
                 <div class="content01"><b>NANA</b><br>Request Tier to Print</div>
               </b-card-text>
            </b-card>
          </div>
        </div>
        <div class="col-md-2">
          <b-card class="bn03" >
              <svg class="icon03" width="40%" height="40%" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-md-2">
          <b-card class="bn06" >
              <svg class="icon06" width="40%" height="40%" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
                <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
              </svg>
                <br>
                <br>
            <b-card-text class="text06">
                Search Device
            </b-card-text>
            <b-button class= "request02" style="color:white; background-color:#f04b4c;">Request</b-button>
          </b-card>
